        ...
        return (
            <section className="Statistic_container">
                <div className="Yellow_ctn">
                    ...
                    <p className="Yellow_ctn_description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim eos est hic illum laboriosam magnam provident recusandae reiciendis rem, reprehenderit! Iste labore porro quos sit.</p>
                </div>
                <div className="Yellow_ctn">
